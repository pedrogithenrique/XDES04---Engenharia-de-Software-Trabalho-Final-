...
def crud_manutencoes():
    ...
    # REGRA DE NEGÓCIO: Filtra funcionários APENAS para Técnico de Manutenção [RFS21]
    funcionarios_validos = [{'id': id, 'nome': f['nome']} 
                            for id, f in db_funcionarios.items() 
                            if f['cargo'] == 'Técnico de Manutenção']
...
if __name__ == '__main__':
    ...
    print("="*50)
    print("Servidor Academia v8.4 (FINAL - GRÁFICOS E REGRAS DE TÉCNICO)")
